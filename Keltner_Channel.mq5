...
input ENUM_MA_METHOD     ma_method = MODE_SMA;       // Select MA Type of smoothing
input ENUM_APPLIED_PRICE  ma_price = PRICE_CLOSE;  // Select MA Applied Price
input int               atr_period = 20;             // Input ATR Period (typically over 10 or 20)
input double            band_multi = 2.00;           // Input the Band Multiplier ATR Desired
//--
//-- Indicator buffers
double KC_Middle[];
double KC_UpperB[];
...
//--- indicator buffers mapping
   ...
   //--
   handleMA=iMA(Symbol(),Period(),period_kc,0,MODE_SMA,ma_price);
   //--
